sap.ui.define([
	"sap/ui/test/Opa5",
	"opensap/orders/HTML5Module/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("opensap.orders.HTML5Module.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "opensap.orders.HTML5Module",
					async: true
				},
				hash: oOptions.hash,
