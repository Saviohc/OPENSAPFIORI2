...
], function (BaseController, JSONModel, formatter, mobileLibrary, Device, MessageToast, ColumnListItem, Utils) {
	"use strict";

	// shortcut for sap.m.URLHelper
	var URLHelper = mobileLibrary.URLHelper;

	return BaseController.extend("opensap.orders.HTML5Module.controller.Detail", {
